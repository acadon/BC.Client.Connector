...
namespace Acadon.Client.Connector.SysTray
{
    ...
    public partial class NotifyIcon : FrameworkElement, IAddChild
    {
        ...
        private void AttachToWindowClose()
        {
            ...
            if (window != null)
                window.Closed += (s, a) => notifyIcon.Dispose();
        }
        ...
        private void InitializeNotifyIcon()
        {
            ...
            notifyIcon.Icon = FromImageSource(this.Icon);
            notifyIcon.Visible = Visibility == Visibility.Visible;
